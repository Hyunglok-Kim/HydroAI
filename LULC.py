...
def copernicus(FP, input_file, dst_crs, resolution, create_output_file=True):
    """
    ...
    - create_output_file: If True, create an output file, else delete it.
    ...
    output_file = f"{FP}/{base_name}_{crs_name}_res{resolution}.tif"
